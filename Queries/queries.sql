-- Creating a list of retirement-eligible employees
-- Creating a list of retirement-eligible employees
...
-- Recreating the retirement_info Table with the emp_no Column (new table for retiring employees)
...
-- Joining departments and managers tables (using aliases)
SELECT d.dept_name,
     dm.emp_no,
     dm.from_date,
     dm.to_date
...
-- Skill Drill: Information on Sales team
select ce.emp_no,
	ce.first_name,
	ce.last_name,
	de.dept_no,
...
-- Skill Drill: Information for the Sales and Development teams
select ce.emp_no,
	ce.first_name,
	ce.last_name,
	de.dept_no,
